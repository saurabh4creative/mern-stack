...
const MyWork = () => {
    ...
    const { isLoading, reportarTickets, isError } = useSelector(state=>state.ticketReducer);
            ...
            <div className='web-layout pt-4 px-4'>
                ...
                <div className='user-layout'>
                    ...
                    <div className='d-flex justify-content-between align-items-center mb-4'>
                        <div>
                             {Object.keys(reportarTickets).length} Issues Found
                        </div>
                        <div>
                    ...
                    <div className='project-list'>
                            ...
                            { !Object.keys(reportarTickets).length && !isLoading && <Message type="info" message={'No Issues Found'} /> }

                            { !isLoading && Object.keys(reportarTickets).length > 0 &&  
